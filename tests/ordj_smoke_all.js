// SMOKE: alle 24 verdener x 3 spil, alle 24 drager, alle 12 lektioner/drills — intet må crashe
const fs = require('fs');
...
// ===== 1) ALLE 24 VERDENER x 3 SPIL KAN STARTES UDEN CRASH =====
...
check('alle 24 verdener x 3 spil starter + render uden crash', crashes.length === 0, JSON.stringify(crashes.slice(0,6)));

// ===== 2) ALLE 24 DRAGEKAMPE KAN STARTES =====
reset();
crashes = [];
...
check('alle 24 dragekampe starter uden crash', crashes.length === 0, JSON.stringify(crashes.slice(0,6)));
